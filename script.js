document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            'bio.subtitle': 'Un biorreactor controla luz, temperatura y agitación de cultivos para crear las condiciones ideales donde microorganismos, tejidos o cultivos celulares se desarrollan con seguridad y reproducibilidad. Estos controles permiten realizar experimentos sobre fotosíntesis, fermentación y otros procesos biológicos.',
            ...
            'resources.badge': 'Recursos para docentes',
            'resources.title': 'Guías y protocolos para el aula',
            'resources.subtitle': 'Descarga nuestros recursos educativos para sacar el máximo provecho a tu biorreactor BioSync.',
